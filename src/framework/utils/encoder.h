...
/* These code is used for efficiently generating a class for each database table using simple representation */ 
...
#define HOST_TO_BIG_TRANSFORM(tpe, expr) (nocc::util::host_endian_trfm< tpe >()(expr))
#define BIG_TO_HOST_TRANSFORM(tpe, expr) (nocc::util::big_endian_trfm< tpe >()(expr))
