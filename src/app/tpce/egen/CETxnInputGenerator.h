...
class CCETxnInputGenerator
{
 public:
    ...
    TIdent                                      m_iActiveSecurityPerServer;
    TIdent                                      m_iStartSecurity;
...
public:
    ...
    *           not applicable.
    */
    CCETxnInputGenerator( const CInputFiles &inputFiles,
    ...
    */
    ...
    void    GenerateBrokerVolumeInput(TBrokerVolumeTxnInput1 &TxnReq);
    /*
